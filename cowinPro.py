...
def vaccine_notifer():
    ...
    base_url = 'https://api.telegram.org/bot'+APIKEY+'/sendMessage?chat_id='+CHATID+'&text={0}'.format(messageFor45)
    ...
    base_url = 'https://api.telegram.org/bot'+APIKEY+'/sendMessage?chat_id='+CHATID+'&text={0}'.format(messageFor18)
    print("Response:",requests.get(base_url))
